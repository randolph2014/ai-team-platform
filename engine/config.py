...
DEFAULT_CONFIG: Dict[str, Any] = {
    ...
    "pipeline": [
        ...
        },
        {
            ...
            "required_artifacts": ["requirement-final.md"],
        },
        {
        ...
        },
        {
            ...
            "required_artifacts": ["task-plan.md"],
        },
        {
        ...
        },
        {
            ...
            "input": ["requirement-final.md", "task-plan.md", "implementation-report.md", "git-diff"],
            "output": {"qa-automation": "test-report.md"},
            "required_artifacts": ["test-report.md"],
            "loopback_to": "develop",
        ...
        },
        {
            ...
            "input": ["requirement-final.md", "task-plan.md", "implementation-report.md", "test-report.md", "git-diff"],
        ...
        },
        {
            ...
            "output": {"retrospect": "final-summary.md"},
            "required_artifacts": ["final-summary.md"],
        },
    ],
    "runner": {
